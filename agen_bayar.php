...
if(isset($_SESSION['login'])) {
       ...
       $_SESSION['username'];
		...
		die("<div style='background-color:#e80000; height:35px;'> <h4 style='text-align:center; color:#ffffff;'> Anda Belum Login Atau Anda Bukan Agen !!!
  ...
  <div id="wrapper">
	...
	die ('SQL Error: ' . mysqli_error($koneksi));
          ...
          <div class='card-body'>
            ...
            <input type='text' class='form-control' placeholder='Cari Kode Transaksi' aria-label='Search' aria-describedby='basic-addon2' id='myInput'>
      ...
      ?>
        ...
        echo "<p style='text-align:center;'> <a href='controller/hapus_transaksi.php?id=". $row['id_transaksi'] . "'>HAPUS TRANSAKSI</a> </p>" ;
        }else{
        echo "<p style='text-align:center;'> <a href='proses_transaksi.php?id=" . $row['id_transaksi'] . "'>PROSES TRANSAKSI</a> </p>" ;
        }?>
      </td>
		   </tr>
			<?php
